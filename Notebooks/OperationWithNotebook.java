...
public class OperationWithNotebook {
    ...
    public boolean notebookIsCorrect(Notebook notebook){
        ...
        for (Criterion criterion : criterionList){
            ...
            }else if (criterion.property.equals("OpRAM")){
                valueNotebook = notebook.getOpRAM();
            }else if (criterion.property.equals("OpSystem")){
                valueNotebook = notebook.getOpSystem();
    ...
    public Map<String, String> descriptionsProperties(){
        ...
        map.put("OpRAM", "Оперативная память");
